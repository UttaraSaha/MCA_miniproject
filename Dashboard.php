       ...
       <div class="section one my-5" id="section1">
          <h2>Educational background</h2><BR>
            ...
            <div class="inner_text">
              <div class="row">
                <div class="col">
              <?php
              $query="SHOW COLUMNS FROM subha8xr_placement.PassOutDetail";
              $table="PassOutDetail where StandardsName='ClassX' ";
          ...
          <div class="col">
            ...
            <div class="inner_text">
              ...
              <?php
              $query="SHOW COLUMNS FROM subha8xr_placement.PassOutDetail";
              $table="PassOutDetail where StandardsName='ClassXII' ";
          ...
          <div class="col">
            ...
            <div class="inner_text">
              ...
              <?php
              $query="SHOW COLUMNS FROM subha8xr_placement.PassOutDetail";
              $table="PassOutDetail where StandardsName='Graduation' ";
